  ...
  return (
    <div className="w-full py-20 lg:py-20">
      <div className="container mx-auto">
        <h2 className="text-3xl md:text-5xl tracking-tighter font-regular mb-12 text-center">Our Team</h2>
      ...
      <div className="w-full py-20 lg:py-20">
        <div className="container flex flex-col mx-auto gap-14">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="flex flex-col gap-2 cursor-pointer hover:opacity-75">
              <div className="mb-4 rounded-md bg-muted aspect-video shadow-md"></div>
              <h3 className="text-xl tracking-tight">Suyeon</h3>
